...
The agent does not exist to accelerate generic productivity. It exists to increase the precision, transmissibility and operational capacity of the ℛenova.

## Primary users

- Carlos Jonathan González Rodríguez / Rey Filósofo by SERESARTE
- SERESARTE collaborators
- Cultural, scientific and institutional allies
- Readers, researchers, artists, technologists and civic designers
...
- Clear separation between philosophical content, interface, agent logic and deployment.
